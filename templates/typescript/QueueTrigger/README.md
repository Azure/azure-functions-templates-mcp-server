...
- [Identity-based connections for Queue Storage](https://learn.microsoft.com/azure/azure-functions/functions-bindings-storage-queue-trigger?pivots=programming-language-typescript&tabs=nodejs-v4%2Cextensionv5#identity-based-connections)
