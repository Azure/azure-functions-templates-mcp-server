# MySQL Trigger - CSharp

This template demonstrates an Azure Function triggered by changes in MySQL databases.

## Configuration

### MySQL Connection Configuration

The MySQL trigger requires a connection to your MySQL database. Configure the `MySqlConnection` setting:
